    ...
    <div className="rounded-[28px] border border-black/5 bg-white p-5 sm:p-7 shadow-soft">
      ...
      <div className="grid grid-cols-3 gap-3">
        <div>
          ...
          <p className="text-[11.5px] text-muted-foreground">In-meeting time</p>
        </div>
        <div>
          <p className="text-[20px] font-semibold tracking-tight text-foreground">{stats?.meetings_hosted ?? 0}</p>
          <p className="text-[11.5px] text-muted-foreground">Hosted</p>
        </div>
        <div>
          <p className="text-[20px] font-semibold tracking-tight text-foreground">{stats?.meetings_attended ?? 0}</p>
          <p className="text-[11.5px] text-muted-foreground">Attended</p>
        </div>
      </div>
